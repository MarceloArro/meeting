...
class _TooltipState extends State<Tooltip> with SingleTickerProviderStateMixin {
  ...
  bool _onTapPressActivated = false;
  ...
  void _handleOnTapPress() {
    _onTapPressActivated = true;
